...
var store = (0, _redux.createStore)(_rootReducer2.default, _initialState2.default, composeEnhancers.apply(undefined, [_redux.applyMiddleware.apply(undefined, middleware)].concat(_toConsumableArray(enchancers))));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPromise_js__ = __webpack_require__(70);
...
function signupReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _initialState2.default.signup;
    var action = arguments[1];
